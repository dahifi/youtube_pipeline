...
copywriting_task = Task(
    ...
    expected_output=(
        "A properly formatted json file with the following keys: file_path: the filename of the original video, usually video/IMG_XXXX.mov; title: the YouTube video title; description: a detailed description. The description should include a brief summary of the video's content, relevant links, call-to-action prompts, followed by a list of tags related to the video's themes and content."
    ),
    agent=producer,
